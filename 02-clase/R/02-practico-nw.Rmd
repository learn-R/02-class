...
- [<i class="fas fa-file-archive"></i> `02-class.zip`](../../02-class/02-clase/02practico.zip) 
...
knitr::include_graphics("../02-clase/input/img/knit-button.png", error = FALSE)
```
...
knitr::include_graphics("../02-clase/input/img/insert-chunk.png", error = FALSE)
```
...
knitr::include_graphics("../02-clase/input/img/chunk-toc.png", error = FALSE)
```
...
knitr::include_graphics("../02-clase/input/img/chunk-options.png", error = FALSE)
```
...
knitr::include_graphics("../02-clase/input/img/output-options.png", error = FALSE)
``` 
...
```{r, echo=FALSE, out.width="40%"}
    knitr::include_graphics("../02-clase/input/img/logo.png", error = FALSE)
```
...
```{r, echo=FALSE, out.width="40%"}
    knitr::include_graphics("../02-clase/input/img/open_rmark_file.png", error = FALSE)
```

2. Luego deben darle un título, poner su nombre y especificar un _formato de salida_ ya sea en **HTML**, **PDF** o **Word**

```{r, echo=FALSE, out.width="60%"}
    knitr::include_graphics("../02-clase/input/img/open_rmark_file2.png", error = FALSE)
```

3. Les creará un archivo con un **_YAML_**, que tendrá la información general del documento y un **_chunk_** 

```{r, echo=FALSE, out.width="60%"}
    knitr::include_graphics("../02-clase/input/img/open_rmark_file3.png", error = FALSE)
```
...
* Este encabezado debe tener una salida (output), esta debe ser en **html**
